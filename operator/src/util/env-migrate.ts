...
export function backfillPanelDomain(content: string): { content: string; change: EnvChange | null; warning?: string } {
...
export function relocatePanelDomain(content: string): { content: string; change: EnvChange | null } {
