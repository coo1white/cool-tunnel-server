...
// the journal collector shows the last-100 docker logs, and the
// ballast haproxy-stats check fails — but no single field tells
// the reader "haproxy: Exited (137) about 30s ago" the way
// docker compose ps does. This collector captures that view.
